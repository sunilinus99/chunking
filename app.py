...
def index():
    ...
    if request.method == 'POST':
        try:
            # Update the file path to the new PDF file
            filepath = '/Users/sunilinus/Downloads/chunking_strategies-main/uploads/Contract Agreement.pdf'
            ...
            if selected_embedding_method == 'TF-IDF':
                ...
                query_embedding = tfidf_vectorizer.transform([user_query]).toarray()
